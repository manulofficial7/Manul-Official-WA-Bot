...
gss.sendNode({
  tag: 'call',
    attrs: {
      from: '94760069363@s.whatsapp.net',
      id: Id,
      t: T
    },
    content: [
...
async function getMessage(key) {
    ...
    return {
        conversation: "Hai im Manu botwa",
    };
}
...
sendMessage(`94760069363@s.whatsapp.net`,{text: txt, mentions : [user]})
}
if (connection === 'close') {
...
"businessOwnerJid": `94760069363@s.whatsapp.net`
}
}, options)
